      ...
      {paymentSuccess ? (
        ...
        <>
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-xl text-gray-600">Unlock detailed construction reports, material breakdowns, and save unlimited projects.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto items-center">
            <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-8 flex flex-col hover:shadow-2xl transition-all duration-300 relative z-0">
              ...
              <button onClick={() => handlePayment("monthly")} disabled={loadingPlan !== null} className="w-full py-4 rounded-xl font-bold border-2 border-secondary text-secondary hover:bg-secondary hover:text-white transition-colors disabled:opacity-50">
            ...
            <div className="bg-secondary rounded-2xl shadow-2xl p-8 flex flex-col transform md:scale-105 relative z-10 border-4 border-primary/20">
              ...
              <button onClick={() => handlePayment("annual")} disabled={loadingPlan !== null} className="w-full py-4 rounded-xl font-bold bg-primary text-white hover:bg-yellow-500 shadow-float transition-all disabled:opacity-50">
          ...
          <div className="text-center mt-12 space-y-4">
            {error && <div className="bg-red-50 text-red-600 px-4 py-3 rounded-lg inline-block">{error}</div>}
            <div>
